SET @dual_hiv_syphilis_rdt_concept_id = (SELECT concept_id FROM concept WHERE uuid ='7ff67b85-7c94-49f6-8187-786fb8f9dbdc');
SET @hiv_and_syphilis_positive_result_id = (SELECT concept_id FROM concept WHERE uuid ='09586337-32d7-4693-bcd4-1ed66a4431b0');
SET @new_hiv_test_obsgroup_concept_id = (SELECT concept_id FROM concept WHERE uuid ='56740c9f-d86e-4240-ad59-7552385a8691');
SET @new_hiv_test_result_concept_id   = (SELECT concept_id FROM concept WHERE uuid ='3cd6c946-26fe-102b-80cb-0017a47871b2');
SET @new_hiv_test_result_value_id   = (SELECT concept_id FROM concept WHERE uuid ='3cd3a7a2-26fe-102b-80cb-0017a47871b2');
SET @new_syphilis_test_obsgroup_concept_id = (SELECT concept_id FROM concept WHERE uuid ='ea5d701a-a8ec-48b2-84c3-2df1c25ac080');
SET @new_syphilis_test_result_concept_id = (SELECT concept_id FROM concept WHERE uuid ='165303AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA');
SET @new_syphilis_test_result_positive_id  = (SELECT concept_id FROM concept WHERE uuid ='3cd8f3f6-26fe-102b-80cb-0017a47871b2');
...
FROM obs o
WHERE o.voided = 0
  AND o.concept_id  = @dual_hiv_syphilis_rdt_concept_id
  AND o.value_coded = @hiv_and_syphilis_positive_result_id;
...
(person_id, concept_id, encounter_id, obs_datetime, location_id, creator,
 date_created, uuid)
SELECT t.person_id,
       @new_hiv_test_obsgroup_concept_id,
...
SELECT t.person_id,
       @new_hiv_test_result_concept_id,
       @new_hiv_test_result_value_id,
       t.encounter_id, t.obs_datetime, t.location_id, t.creator,
...
(person_id, concept_id, encounter_id, obs_datetime, location_id, creator,
 date_created, uuid)
SELECT t.person_id,
       @new_syphilis_test_obsgroup_concept_id,
       t.encounter_id, t.obs_datetime, t.location_id, t.creator,
...
(person_id, concept_id, value_coded, encounter_id, obs_datetime, location_id, creator,
 obs_group_id, date_created, uuid)
SELECT t.person_id,
       @new_syphilis_test_result_concept_id,
       @new_syphilis_test_result_positive_id,
       t.encounter_id, t.obs_datetime, t.location_id, t.creator,
