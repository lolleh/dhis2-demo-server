...
<div class="clear"></div>
    ...
    <div class="dashboard clear row">
        ...
        <!-- The treatment-register quick links are rendered unconditionally:
          the visitActions extension list can be empty (all stock demo forms are
          unpublished), and activeVisit is frequently null on this stack, so the
          "Current Visit Actions" block used to gate them and the forms never
          showed. visitIdParam stays empty when there is no active visit. -->
        <%
            def visitIdParam = (activeVisit && activeVisit.visit) ? "&visitId=${ activeVisit.visit.id }" : ""
        %>
        ...
        <div class="action-section col-12 order-first d-lg-none">
            <ul class="float-left">
                ...
                <li class="float-left">
                    <a href="/${ ui.contextPath() }/htmlformentryui/htmlform/enterHtmlFormWithStandardUi.page?patientId=${ patient.patient.id }${ visitIdParam }&formUuid=eaad2f41-de8f-48b7-9d40-50187fb95932" class="float-left">
                        <div class="row">
                           <div class="col-1 col-lg-2">
                              <i class="icon-clipboard"></i>
                            </div>
                            <div class="col-11 col-lg-10">
                               Above Five (General) Treatment Register
                            </div>
                        </div>
                    </a>
                </li>
                <li class="float-left">
                    <a href="/${ ui.contextPath() }/htmlformentryui/htmlform/enterHtmlFormWithStandardUi.page?patientId=${ patient.patient.id }${ visitIdParam }&formUuid=26f8e5c5-8787-43bd-af4c-21674f434d37" class="float-left">
                        <div class="row">
                           <div class="col-1 col-lg-2">
                              <i class="icon-clipboard"></i>
                            </div>
