export class OpenmrsClient {
    ...
    async createPatient(patient) { return this.post('/patient', patient) }

    async createEncounter(encounter) { return this.post('/encounter', encounter) }

    async createObservation(obs) { return this.post('/obs', obs) }

    async getByUuid(resource, uuid) { return this.get(`/${resource}/${uuid}?v=full`) }
}
